...
class S2E(BertPreTrainedModel):
    ...
    def _prune_top_lambda_n_spans(self, mention_logits, attention_mask):
        """
    ...
    def forward(self, input_ids, attention_mask=None, start_entity_mention_labels=None, end_entity_mention_labels=None,
        ...
        span_starts, span_ends, span_mask, top_k_mention_logits = self._prune_top_lambda_n_spans(mention_logits, attention_mask)
